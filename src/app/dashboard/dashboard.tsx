...
import type { Card, Carrier, Household, OptimizationResult, RecommendationType, Service, UserSub } from "@/lib/types";
...
export default function Dashboard({
  ...
  const runOptimizer = () => {
    const r = optimize(
      ...
      [],
      { services: SERVICES, carriers: CARRIERS, cards: CARDS }
    );
    setResults(r);
    setStep("results");
  };
